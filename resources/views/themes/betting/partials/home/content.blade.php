        ...
        <tr>
            ...
            <th class="col-5">
               ...
               <span>
                ...
                <span>
                   @{{item.game_category.name}} <span v-if="item.name">- @{{item.name}} </span>
               </span>
            </th>
...
{{--Start Here--- I am adding condition to check for my Jackpot list in category whether live or upcoming--}}

{{--<div  v-if="checkJackpot = true && (showType == 'upcoming' || showType == 'live')" v-for="(item, index) in (upcoming_filter + allSports_filter" class="table-parent table-responsive d-sm-block d-none">--}}
{{--    <table class="table table-striped">--}}
{{--        <thead>--}}
{{--        <tr>--}}
{{--            <th class="text-center">--}}
...
{{--    </table>--}}
{{--</div>--}}
{{--End Here---- I am adding condition to check for my Jackpot list in category whether live or upcoming--}}
