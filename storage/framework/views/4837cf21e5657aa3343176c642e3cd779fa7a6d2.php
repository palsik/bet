            ...
            methods: {
                async getMatches() {
                    ...
                    if (routeName == 'category') {
                        ...
                        // Checking if the route clicked has keyword Jackpot and
                        // setting a boolean that will load a specific template for jackpot
                        // if(routeName.path.includes('Jackpot')){
                        //     _this.checkJackpot = true;
                        //
                        // }
                    }
...
<?php echo $__env->make($theme.'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bet\resources\views/themes/betting/home.blade.php ENDPATH**/ ?>
